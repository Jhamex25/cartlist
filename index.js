let user = {
    ...
    cartlist: [{
            id: 1,
            img: "./img/footrest280.jpg",
            product: "Footrest",
            price: 280
        },
        {
            id: 2,
            img: "./img/HengBolts25.jpg",
            product: "Heng Bolts",
            price: 25
        },
        {
            id: 3,
            img: "./img/Mioiflatseat9501.jpg",
            product: "Mio i flatseat",
            price: 950
        },
        {
            id: 4,
            img: "./img/motooil-1.jpg",
            product: "Moto Oil",
            price: 300
        },
        {
            id: 5,
            img: "./img/Mt8racingpipe1500.jpg",
            product: "Mt8 Racing Pipe",
            price: 1500
        },
        {
            id: 6,
            img: "./img/RccShock4500.jpg",
            product: "RCC Shock",
            price: 4500
        },
        {
            id: 7,
            img: "./img/RcingBrdrBrkLvr470.jpg",
            product: "Racing Brother Brake",
            price: 470
        },
        {
            id: 8,
            img: "./img/RidrHengKkStrtr300.jpg",
            product: "Rider Heng Kick Start",
            price: 300
        },        
        {
            id: 9,
            img: "./img/Sidemror300-1.jpg",
            product: "Side Mirror",
            price: 300
        },
        {
            id: 10,
            img: "./img/SkydrvCalpr499-1.jpg",
            product: "Sky Drive Caliper",
            price: 499
        },
        {
            id: 11,
            img: "./img/Spedtunerset700-1.jpg",
            product: "Speed Turner Set",
            price: 700
        },
        {
            id: 12,
            img: "./img/sprocket-1.jpg",
            product: "Sprocket",
            price: 450
        },
        {
            id: 13,
            img: "./img/SzkiSkydveBelt1000.jpg",
            product: "Suzuki Skydrive Belt",
            price: 1000
        },
        {
            id: 14,
            img: "./img/Vs1Org320-1.jpg",
    ...
    showproducts() {
        ...
        this.cartlist.forEach(
            function (iteminthelist) {
                cartlist +=
                `<div class="card d-inline-block" style="width: 18rem; box-shadow: 0px 5px 15px rgba(0,0,0,0.6); padding  10px;">
